    ...
    <div className="mx-auto max-w-3xl px-6 py-24">
      ...
      <div className="mt-8 space-y-6 text-text-secondary text-[13px] leading-relaxed">
        <section>
          ...
          <p>
            NexVid does not host, upload, store, or distribute any media content
            whatsoever. The application is an interface that references
            third-party sources through provider APIs. Stream delivery and
            availability are controlled by those providers, not by NexVid.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-text-muted">
            ...
            <li>
              Optional backend deployments may sync user settings/watchlist data
            </li>
        ...
        <section>
          ...
          <p>
            If you believe any third-party content accessible through NexVid
            infringes on your copyright, please direct your DMCA takedown
            request to the relevant hosting provider that actually serves the
            content. NexVid cannot remove content from external hosts.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            purposes. Users are responsible for complying with applicable
        ...
        <section className="pt-6 border-t border-[var(--border)]">
          ...
          <p className="mb-2">
            For any legal or copyright-related inquiries, please contact our
            security team:
          </p>
          <a
