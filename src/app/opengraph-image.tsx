  ...
  return new ImageResponse(
    <div
      style={{
        ...
        display: "flex",
        background:
          "linear-gradient(135deg, #050505 0%, #14142a 55%, #0a0a0a 100%)",
        color: "white",
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: 999,
          background:
            "radial-gradient(circle, rgba(129,140,248,0.26) 0%, rgba(129,140,248,0) 72%)",
        }}
      />
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div style={{ fontSize: 42, fontWeight: 700, letterSpacing: -1.2 }}>
            NexVid
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            Trending picks, smart search, watchlists, and seamless streaming on
            NexVid.
          </div>
        </div>
