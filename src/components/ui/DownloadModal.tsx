...
export function DownloadModal({
  ...
  const { febboxApiKey, customAccentHex, accentColor } = useSettingsStore(
    (s) => s.settings,
  );
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-xl rounded-[28px] border border-white/10 bg-[#050608]/95 p-6 animate-scale-in shadow-[0_24px_80px_rgba(0,0,0,0.75)]"
