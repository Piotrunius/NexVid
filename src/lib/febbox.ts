export const PUBLIC_FEBBOX_TOKEN_ENV_NAME = 'PUBLIC_FEBBOX_TOKEN';

export const PUBLIC_FEBBOX_TOKEN_ENV_VALUE =
  process.env.NEXT_PUBLIC_FEBBOX_TOKEN || process.env.PUBLIC_FEBBOX_TOKEN || '';

export const PUBLIC_FEBBOX_TOKEN_VALUE = PUBLIC_FEBBOX_TOKEN_ENV_VALUE;
