...
module.exports = {
    ...
    theme: {
        extend: {
            fontFamily: {
                sans: ['Inter', '-apple-system', 'BlinkMacSystemFont', 'SF Pro Display', 'SF Pro Text', 'Helvetica Neue', 'system-ui', 'sans-serif'],
            },
            colors: {
                bg: {
            ...
            boxShadow: {
                ...
                'glass-hover': '0 16px 48px rgba(0,0,0,0.9), 0 0 0 1px rgba(255,255,255,0.1)',
